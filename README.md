...
Results are visible at http(s)://[siteurl]/receipt/ in json format
...
- Create a copy of ``tax_calculator/settings/local.py.example``:  
  `cp tax_calculator/settings/local.py.example tax_calculator/settings/local.py` (remembering you should replace `tax_calculator` with your project's name!).
